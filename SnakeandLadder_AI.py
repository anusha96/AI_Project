...
def welcome_msg():
    ...
    This game is played between a human and an AI agent.
    Rules:
      1. Initally both the players are at starting position i.e. 0. 
         Take it in turns to roll the dice. 
         Move forward the number of spaces shown on the dice.
         †he player then can choose the number of moves i.e if the dice rolled is 3 then the player can choose to move 0,1,2 or 3.
...
def start():
    ...
    while True:
        ...
        print("\nRolling dice for the AI agent...")
        dice_value = get_dice_value()
        dice_input_2 = random.choice(range(dice_value))
        time.sleep(SLEEP_BETWEEN_ACTIONS)
        print("The AI agent selected ",dice_input_2)
        print(player2_name + " moving....")
        player2_current_position = snake_ladder(player2_name, player2_current_position, dice_input_2)

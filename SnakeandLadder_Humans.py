...
#This game is between two human players
...
def welcome_msg():
    ...
    This is between two human players.
    Rules:
      1. Initally both the players are at starting position i.e. 0. 
         Take it in turns to roll the dice. 
         Player can choose the number of moves to move. i.e if the dice rolled is 3 then the player can select 0,1,2,3 to move on the board.
...
def start():
    ...
    while True:
        ...
        dice_value = get_dice_value()
        print("Select a value between 0 to ",dice_value)
        dice_input_2 =int(input("\n" + player2_name + ": " + random.choice(player_turn_text) + " select a value: "))
        time.sleep(SLEEP_BETWEEN_ACTIONS)

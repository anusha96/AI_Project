...
def simulate_game(game_size):
    #Requirement 8 and 9
    model = process(board_size=game_size,train_data_cnt=500,test_data_cnt=200,learning_rate=0.01,epochs=500)
    ...
    plt.savefig("scores_simulation_NN.png")
    plt.show()
    ...
    plt.savefig("scores_simulation_TreeBased.png")
    plt.show()
